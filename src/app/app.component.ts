...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, EmpresaComponent, LoginComponent, RegistroProductoComponent, RegistroEstablecimientoComponent, RegistroProductoEstablecimientoComponent],
